...
//                            std::cout << "fourTracksFittingMethod1::fitAll() : tktk match found!!!!\n";
			...
			// information to final partifcle.
			...
			reco::RecoChargedCandidate pTkCand( 1, pTkMom, tktkCand.vertex());
			...
			reco::RecoChargedCandidate nTkCand(-1, nTkMom, tktkCand.vertex());
			...
			addp4.set(MuMuCand);
			reco::VertexCompositeCandidate TkTkCand( 0, pTkMom+nTkMom, tktkCand.vertex(), tktkCand.vertexCovariance(), tktkCand.vertexChi2(), tktkCand.vertexNdof() );
